...
class Tcgeneration extends Admin_Controller
{
    ...
    public function create()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            if ($this->input->post('is_mother_tongue') == 1) {
                $mothertongue = $this->input->post('is_mother_tongue');
            }
            ...
            $data = array(
                ...
                'tc_first_lang'          => $first_sub,
                'tc_second_lang'         => $second_sub,
    ...
    public function delete($id)
    {
        ...
        redirect('admin/tcgeneration/index');
    }
